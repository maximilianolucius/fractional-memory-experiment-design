...
The benchmark validated the theoretical pipeline; this section provides experimental protocols grounded in the microcosm literature~\cite{E10,E11,E12} for laboratory implementation.
\subsubsection{Design A --- stability-verdict experiment at the certified baseline}
...
Apply a small collocated prey or predator pulse, with amplitude selected by the safety bound in \texttt{12\_SAFE\_EXPERIMENT\_DESIGN.md}.
...
\subsubsection{Design B --- fair stable frequency-response benchmark}
...
\subsubsection{Design C --- repeated-pulse memory-shape experiment}
...
\subsubsection{Design D --- latent-environment disambiguation}
...
\subsubsection{Design E --- safe adaptive protocol near the Allee threshold}
...
\subsubsection{Minimum simulation matrix}
